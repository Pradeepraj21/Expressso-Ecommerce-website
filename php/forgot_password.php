      ...
      <div id="sign-dialog">
        ...
        <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" style="max-width:500px; margin:auto" method="POST">
              ...
              <div class="main-container5">
                  ...
                  <div class="title1"><label for="sign up on expresso">FORGOT PASSWORD!</label></div>

                  <div><label for="text" class="text_password">(Please Enter your Email ID associated with your Expressso account.)</label></div>
