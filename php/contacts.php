	...
	<body>
		...
		<div class="help-about">
			...
			<div id="abt-are">
				...
				<h2>Who we are</h2>
				<p>
					Expressso is an online shopping site where a customer are free to visit the site and explore their minds through the site and can get to know how the website actually works. The site also is implemented with a classic Design UX and with soothing features to the user. It reflects the people's express and needs.

					<span id="moreText-1" style="display: none">
						Expressso has a collection of groceries, clothings, mobile-phones, varieties of laptops, smooth quality headphones and earphones to introduce to the people. The site in also embedded with lot of interactive sessions where the customer can free contact and share their feelings and opinion to the company.
					</span>
				</p>
		...
		<div class="help-con" style="color: white">
			...
			<center><div id="con-container">
				...
				<div id="contact_details">
					<div id="mem-1-details"><span class="fa fa-star checked"></span> <span class="emp_names">Nadar Pradeepraj Mani (TCS2021052) </span><br><br>
						<p><i class="fas fa-address-book"></i>&nbsp;&nbsp; +91 9820316041 </p>
						<p><i class="fas fa-envelope"></i>&nbsp;&nbsp; nadarpradeepraj21@gmail.com</p>
					</div>

					<br>
					<div id="mem-1-details"><span class="fa fa-star checked"></span> <span class="emp_names">Peter Joel Elango (TCS2021061)</span><br><br>
						<p><i class="fas fa-address-book"></i>&nbsp;&nbsp; +91 8655398672</p>
						<!--<p><i class="fas fa-envelope"></i>&nbsp;&nbsp; </p>-->
					</div>

					<br>
					<div id="mem-1-details"> <span class="fa fa-star checked"></span> <span class="emp_names">Phull Harshivi Sanjay (TCS2021062)</span><br><br>
						<p><i class="fas fa-address-book"></i>&nbsp;&nbsp; +91 9322551441</p>
						<!--<p><i class="fas fa-envelope"></i>&nbsp;&nbsp; </p>-->
					</div>

					<br>
					<div id="mem-1-details"> <span class="fa fa-star checked"></span> <span class="emp_names">Michael Winston Jeyakumar (TCS2021045)</span><br><br>
						<p><i class="fas fa-address-book"></i>&nbsp;&nbsp; +91 8828261391</p>
						<!--<p><i class="fas fa-envelope"></i>&nbsp;&nbsp; </p>-->
					</div>
				</div>
