...
$db = mysqli_select_db($connection, 'erp');
...
if(isset($_POST['delete']))
{
	...
	$query = "DELETE FROM beveragedataset WHERE Product_name='$id'";
	
	$query_run=mysqli_query($connection,$query);
	if($query_run)
	{
		echo '<script type="text/javascript"> alert("SUCCESS: PRODUCT DELETED") </script>';
	}
	else
	{
		echo '<script type="text/javascript"> alert("ERROR: Could not able to Delete Product") </script>';
	}
}
?>
 </div>
