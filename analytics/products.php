...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><img src="../pics/logo_icon.png" alt="logo" width="20px" height="20px"> Product Analytics</b></h5></br>
  </header>


  <div class="w3-container">
  <ul type="square">
    <li><a style="text-decoration:none" href="AddProduct.php" class="add_link"><b>ADD PRODUCT</b></a></br></br></li>
    <!--<li><a style="text-decoration:none" href="#" class="add_link"><b>EDIT / UPDATE PRODUCT</b></a></br></br></li>-->
    <li><a style="text-decoration:none" href="DeleteProduct.php" class="add_link"><b>DELETE PRODUCT</b></a></li>
  </ul>
  ...
  <div class="w3-container">
    ...
    <table class="w3-table w3-striped w3-bordered w3-border w3-hoverable w3-white">
      ...
      <?php
      $select = mysqli_query($conn,"SELECT DISTINCT title,url,pid,cat FROM page_analytics WHERE page_name='discription' ORDER BY id DESC LIMIT 20");
